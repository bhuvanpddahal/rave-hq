...
* **Create New API key**: If the request gets successfull, you'll be redirected to the app details page where now instead of `Lost API Key` button, you'll find `Create API Key` button which you can use to create a new API key.
